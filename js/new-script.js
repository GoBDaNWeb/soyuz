...
function _setStepProgressId() {
	...
	document.querySelectorAll('.steps-principe__steps-progress').forEach((item, i) => {
		item.setAttribute('id', 'radialprogress-' + i)
	})
}
...
var swiper = new Swiper("#about .benefits-about._mob .swiper", {
	slidesPerView: 1.2,
	spaceBetween: 20,
	breakpoints: {
		768: {
